            ...
            <div class="table-responsive">
                <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <td><h5>
                            <a href='#' class =' btn btn-warning btn-circle' data-toggle='modal' title='Edit' data-target='#edit' onClick=\"EditData('" . $row->id_analisis . "','" . $row->catatan . "','" . $row->status . "')\"><i class='fas fa-edit'></i></a>
    ...
    <div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url('kabag/edit'); ?>" method="post">
