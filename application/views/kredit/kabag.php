        ...
        <tbody>
            ...
            foreach ($query->result() as $row) {
                ...
                echo "<tr>
                        ...
                        <td><h5>
                            <a href='#' class =' btn btn-warning' data-toggle='modal' title='Edit' data-target='#edit' onClick=\"EditData('" . $row->id_analisis . "','" . $row->catatan . "','" . $row->status . "')\"><i class='fas fa-edit'></i></a>
