                ...
                <form action="<?= base_url('analisa/add_scoring'); ?>" method="post" id="form_pengajuan">
                    <div class="modal-body">                       
						...
						<ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
							...
							<li class="nav-item" role="presentation">
								<a class="nav-link" id="pills-capacity-tab" data-toggle="pill" href="#pills-capacity" role="tab" aria-controls="pills-capacity" aria-selected="false">Capacity</a>
							</li>
							<li class="nav-item" role="presentation">
								<a class="nav-link" id="pills-capital-tab" data-toggle="pill" href="#pills-capital" role="tab" aria-controls="pills-capital" aria-selected="false">Capital</a>
							</li>
							<li class="nav-item" role="presentation">
								<a class="nav-link" id="pills-collateral-tab" data-toggle="pill" href="#pills-collateral" role="tab" aria-controls="pills-collateral" aria-selected="false">Collateral</a>
							</li>
							<li class="nav-item" role="presentation">
								<a class="nav-link" id="pills-condition-tab" data-toggle="pill" href="#pills-condition" role="tab" aria-controls="pills-condition" aria-selected="false">Condition</a>
							</li>
						</ul>
						<br>
						<div class="tab-content" id="nav-tabContent">
							...
							<div class="tab-pane fade" id="pills-capital" role="tabpanel" aria-labelledby="pills-capital-tab">      
								<table class="table table-striped">
									<thead>
										<tr>
										<th>Aspek & Faktor</th>
							...
							<div class="tab-pane fade" id="pills-collateral" role="tabpanel" aria-labelledby="pills-collateral-tab"> 
								...
								<script>
									...
									const radioButtons = document.querySelectorAll('select[name="group"]');
            ...
            <div class="modal-content">
                ...
                <form action="<?= base_url('analisa/update_resume'); ?>" method="post" id="form_resume">
                    <div class="modal-body">                       
						...
						<ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
							<li class="nav-item" role="presentation">
								<a class="nav-link active" id="pills-satu-tab" data-toggle="pill" href="#pills-satu" role="tab" aria-controls="pills-satu" aria-selected="true">1</a>
							</li>
							<li class="nav-item" role="presentation">
								<a class="nav-link" id="pills-dua-tab" data-toggle="pill" href="#pills-dua" role="tab" aria-controls="pills-dua" aria-selected="false">2</a>
							</li>
							<li class="nav-item" role="presentation">
								<a class="nav-link" id="pills-tiga-tab" data-toggle="pill" href="#pills-tiga" role="tab" aria-controls="pills-tiga" aria-selected="false">3</a>
							</li>
							<li class="nav-item" role="presentation">
								<a class="nav-link" id="pills-empat-tab" data-toggle="pill" href="#pills-empat" role="tab" aria-controls="pills-empat" aria-selected="false">4</a>
							</li>
							<li class="nav-item" role="presentation">
								<a class="nav-link" id="pills-lima-tab" data-toggle="pill" href="#pills-lima" role="tab" aria-controls="pills-lima" aria-selected="false">5</a>
							</li>
						</ul>
						<br>
						<div class="tab-content" id="nav-tabContent">
