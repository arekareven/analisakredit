...
<div class="container-fluid">
    ...
    <button type="button" class="btn btn-info btn-icon-split" data-toggle="modal" data-target="#bismillah2">
        <span class="icon text-white-50">
            <i class="fas fa-arrow-down"></i>
        </span>
                ...
                <table class="table table-hover" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        foreach ($query2->result() as $row) {
                            echo "<tr>
                        <td>" . $row->keterangan1 . "</td>
                        <td>" . 'Rp. ' . number_format($row->pengeluaran2) . "</td>                      
                        <td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body after-add-more_cf2">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-angsuran" role="tabpanel" aria-labelledby="pills-contact-tab">
                            <form action="<?= base_url('dummy/add3'); ?>" method="post">
                                <div class="row">
                                    <div class="col-md-1 mb-3">
                                        <label for="no" class="form-label">No</label>
    ...
    <div class="modal fade" id="bismillah2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body after-add-more_cf2">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="pills-contact-tab" data-toggle="pill" href="#pills-lain" role="tab" aria-controls="pills-contact" aria-selected="false">Biaya Lain-Lain</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-angsuran" role="tab" aria-controls="pills-contact" aria-selected="false">Biaya Angsuran Hutang</a>
                        </li>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-lain" role="tabpanel" aria-labelledby="pills-contact-tab">
                            <form action="<?= base_url('dummy/add3'); ?>" method="post">
                                <div class="row">
                                    <div class="col-md-1 mb-3">
                                        <label for="no" class="form-label">No</label>
