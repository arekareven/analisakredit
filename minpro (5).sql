...
(2, 11, '6 (Enam)', 'AE 7359 NA', 'Yuliati', '-', 'Isuzu', 'Microbus', 2013, 'Putih Hijau Kuning', '2771 cc', 'MHCNKR', 'M055107', 'O-05769918', '', '', '', '-');
...
(5, 11, 'Tanah Pertanian', 'Giri Purnomo', 'Desa Soco RT 05 RW 02 Kec. Jogorogo Kab. Magetan', '252', 'Desa Soco RT 05 RW 02 Kec. Jogorogo Kab. Magetan', '2011-06-09', '05/2011', '2270', '', 'Milik sendiri', 'Sebidang tanah pertanian yang sudah dikeringkan terletak di pinggir jalan raya Jogorogo- Paron mempunyai nilai marketable yang baik. (proses balik nama ke calon debitur)', '60', '-', '81720000', '78000', '681000000', '', '500000000');
...
--
ALTER TABLE `capital_b`
  MODIFY `id_capi` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `cashflow_b`
  MODIFY `id_cf` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
...
--
ALTER TABLE `karakter`
  MODIFY `id_char` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `latar_belakang`
--
ALTER TABLE `latar_belakang`
  MODIFY `id_lb` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
